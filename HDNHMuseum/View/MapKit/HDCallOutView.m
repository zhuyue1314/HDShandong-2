...
- (float)calculateCentreWidth {
	...
	CGSize titleSize = [self.annotation.title sizeWithFont:[UIFont boldSystemFontOfSize:TITLE_STANDALONE_FONT_SIZE] constrainedToSize:CGSizeMake(CALLOUT_MAX_WIDTH, TITLE_STANDALONE_LABEL_HEIGHT) lineBreakMode:NSLineBreakByTruncatingTail];
	...
	if (self.annotation.subtitle) {
		CGSize subtitleSize = [self.annotation.subtitle sizeWithFont:[UIFont boldSystemFontOfSize:SUBTITLE_FONT_SIZE] constrainedToSize:CGSizeMake(CALLOUT_MAX_WIDTH, SUBTITLE_LABEL_HEIGHT) lineBreakMode:NSLineBreakByTruncatingTail];
