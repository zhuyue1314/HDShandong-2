...
{
    if ([_delegate respondsToSelector:@selector(PomeloFailed:withError:)])
    {
        [_delegate PomeloFailed:self withError:error];
    }
}
# pragma mark -
